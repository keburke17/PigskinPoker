...
2. `npm test` before committing: **295 passed, 1 skipped, 18 files**. If the output says
...
295 tests. Three groups worth knowing about:
...
- **`rls.test.js`, `server.test.js`, `bootstrap.test.js`** need the local Supabase stack
  (started for you by `npm run dev`) and **skip themselves silently without it** - 108 of the 295
