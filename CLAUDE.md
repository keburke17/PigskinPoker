...
2. `npm test` before committing: **675 passed, 29 files**. If the output says
...
675 tests. Three groups worth knowing about:
...
- **`rls.test.js`, `server.test.js`, `bootstrap.test.js`** need the local Supabase stack
  (started for you by `npm run dev`) and **skip themselves silently without it** - 180 of the 675
