        ...
        <>
          ...
          {teams.length === 0 ? (
            ...
            <>
              ...
              {/* Says what the button does now that it does two things. If the feed is
                  down the deal still goes ahead on the current pool and the activity log
                  says so - see dealPeriod in server/operations.js. */}
